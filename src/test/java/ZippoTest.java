...
//    body.places[0].state -> body("places[0].state"
        ...
        public void extractingJsonPathIntlist() {
            ...
            List<Integer> idlar=
                    ...
                    ;
            System.out.println("id = " + idlar);

            SoftAssert softAssert=new SoftAssert();

            softAssert.assertTrue(idlar.contains(4195));
            softAssert.assertTrue(idlar.contains(6251));


        }
        @Test
        public void extractingJsonPathresponseAl() {
            ...
            Response body=
                    given()
                            ...
                            //.log().body()
                            .statusCode(200)
                            .extract().response()//response body de her şey alabilir

                    ;
           List<Integer> idlar=body.path("data.id");
           List<String> names=body.path("data.name");
           int limit=body.path("meta.pagination.limit");

            System.out.println("limit = " + limit);
            System.out.println("names = " + names);
            System.out.println("idlar = " + idlar);
